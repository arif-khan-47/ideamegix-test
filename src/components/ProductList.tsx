  ...
  return (
    <div className='flex justify-center flex-wrap gap-3 mb-10 mt-5'>
      {filteredProducts.map((product:any, index:any) => (
        <div className="w-60 bg-green-200 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl cursor-pointer" onMouseOver={() => setIsHover(index)} onMouseOut={() => setIsHover(undefined)}>
